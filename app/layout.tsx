...
export const metadata: Metadata = {
  title: "Airlock - the golden pnpm 12 CI template",
  description:
    "A CI-green reference wiring pnpm 12 supply-chain defaults, a regenerating audit-fix pipeline, Dependabot cooldown and SHA-matched unattended auto-merge for solo Next.js on Vercel.",
  metadataBase: new URL(SITE_URL),
  alternates: { canonical: "/" },
  openGraph: {
    title: "Airlock",
    description: "The golden pnpm 12 + Dependabot + audit-fix CI template for solo Next.js on Vercel.",
    url: SITE_URL,
    type: "website",
  },
  twitter: {
